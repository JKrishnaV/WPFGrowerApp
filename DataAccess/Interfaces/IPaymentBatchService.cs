...
namespace WPFGrowerApp.DataAccess.Interfaces
{
    ...
    public interface IPaymentBatchService
    {
        ...
        Task<PaymentBatch> CreatePaymentBatchAsync(int paymentTypeId, DateTime batchDate, string notes = null);
        ...
        /// <summary>
        /// Updates the totals for a payment batch after processing.
        /// </summary>
